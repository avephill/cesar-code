...
X <- c("cowplot", "ggplot2","dplyr", "car", "olsrr", "tidyverse", "RColorBrewer", "reshape2", "egg", "ecodist", "corrplot", "vegan", 
       # "glmmTMB", 
       "lme4", "lmerTest", "MASS", "emmeans", "performance", "rptR", "coin")
...
##VISUALIZE
Visualize sums of the species richness of greenspaces within each city
...
# Avery: These are identical to the previous dm values.
dm <- dm %>% 
  dplyr::mutate_if(
    is.numeric,
...
# Avery: I don't see any red flags above, but I think the culprit might be between here and the next plot
